...
public class DanhSachGiaoDich {
	...
	public void nhap(Scanner scan) {
		...
		do {
			...
			System.out.println("1. Insert Gold Transaction");
			System.out.println("2. Insert Currency Transaction");
			...
			case 0:
				...
				break;
			default:
				System.out.println("Please insert 0, 1, 2");
			}
		} while (flag);
	}
	...
	public void xuatGiaoDichTheoTieuChi() {
		System.out.println("Transactions more than " + MOT_TY);
		for (GiaoDich gd : this.listGiaoDich) {
